...
var EmojiImgSources = [
    getFileUrl("images/cat.svg"),getFileUrl("images/gobo.svg"),getFileUrl("images/waffle.svg"),getFileUrl("images/taco.svg"),getFileUrl("images/sushi.svg"),getFileUrl("images/pizza.svg"),getFileUrl("images/candycorn.svg"),getFileUrl("images/apple.svg"),getFileUrl("images/cupcake.svg"),getFileUrl("images/cat.png"),getFileUrl("images/aww-cat.png"),getFileUrl("images/cool-cat.png"),getFileUrl("images/tongue-out-cat.png"),getFileUrl("images/wink-cat.png"),getFileUrl("images/lol-cat.png"),getFileUrl("images/upside-down-cat.png"),getFileUrl("images/fav-it-cat.png"),getFileUrl("images/pizza-cat.png"),getFileUrl("images/love-it-cat.png"),getFileUrl("images/rainbow-cat.png"),getFileUrl("images/huh-cat.png"),getFileUrl("images/broccoli.svg"),getFileUrl("images/camera.svg"),getFileUrl("images/compass.svg"),getFileUrl("images/suitcase.svg"),getFileUrl("images/map.svg"),getFileUrl("images/binoculars.svg"),getFileUrl("images/10mil.svg"),getFileUrl("images/pride.svg"),getFileUrl("images/blm.svg"),"⌚️","⏰","⏱", "⏲","⌨", "☎️","⌛️","⚖️","⚙️","✉️","✂️","✒️","☂️","✏️","☕️","♟️","⚰️","⚱️","⛏️","⚔️", "⚒️","⛓️","⚗️","⛑️","⭐️","✨","⚡️","☄️","☀️","⛅️","☁️","⛈️","⛄️","❄️","☔️","☘️","☹️","✌️","☝️","✍️","✋","☺️","⚽️","⚾️","⛳️","⛹️","⛷️","⛸️","✈️","⛵️","Ⓜ","⚓️","⛽️","⛲️","⛺️","⛪️","⛰️","⛱️","⛴️","⛩️","♨️","❗️","❕","❓","❔","©","®","‼","⁉","™","➕","➖","➗","✖️","⛔","⭕","❌","✔️","〰","〽","⚠️","☑️","✅","❎","▶","⏩","⏪","⏫","⏬","ℹ","⏭","⏮","⏯","⏏","◀","➡️","⬅","⬆","⬇","↗","↘","↙","↖","↪","↩","⤴","⤵","✳️","✴️","❇️","㊗","㊙","⚕️","☦️","♾️","⚛️","⛎️","✝️","☪️","☮️","☯️","☸️","♈️","♉️","♊️","♋️","♌️","♍️","♎️","♏️","♐️","♑️","♒️","♓️","❤️","❣️","♠️","♣️","♥️","♦️","♀️","♂️","♻️","☢️","☣️","⚜️","➰️","➿️","☠️","⬛","⬜","⚪️","⚫️","▪","▫","◻","◼","◽","◾","(◕‿◕✿)","(づ￣ ³￣)づ",'(⁄ ⁄•⁄ω⁄•⁄ ⁄)',"( ་ − ་ )ུ ","( ༎ຶ ۝ ༎ຶ )","( う-´)づ︻╦̵̵̿╤──   (˚☐˚”)/","_(┐「ε:)_","ʕ ·(エ)· ʔ"," (⊚︷⊚) "," ~(￣▽￣)~ "," O(∩_∩)O "," ٩( ‘ω’  )و "," ★ "," ✪ "
]

var EmojiKeyboardData = [
    " _meow_ "," _gobo_ "," _waffle_ "," _taco_ "," _sushi_ "," _pizza_ "," _candycorn_ "," _apple_ "," _cupcake_ "," _:)_ "," _:D_ "," _B)_ "," _:P_ "," _;P_ "," _:'P_ "," _P:_ "," _**_ "," _:D<_ "," _<3_ "," _:))_ "," _:3_ "," _broccoli_ "," _camera_ "," _compass_ "," _suitcase_ "," _map_ "," _binoculars_ "," _10mil_ "," _pride_ "," _blm_ ","⌚️","⏰","⏱", "⏲","⌨", "☎️","⌛️","⚖️","⚙️","✉️","✂️","✒️","☂️","✏️","☕️","♟️","⚰️","⚱️","⛏️","⚔️", "⚒️","⛓️","⚗️","⛑️","⭐️","✨","⚡️","☄️","☀️","⛅️","☁️","⛈️","⛄️","❄️","☔️","☘️","☹️","✌️","☝️","✍️","✋","☺️","⚽️","⚾️","⛳️","⛹️","⛷️","⛸️","✈️","⛵️","Ⓜ","⚓️","⛽️","⛲️","⛺️","⛪️","⛰️","⛱️","⛴️","⛩️","♨️","❗️","❕","❓","❔","©","®","‼","⁉","™","➕","➖","➗","✖️","⛔","⭕","❌","✔️","〰","〽","⚠️","☑️","✅","❎","▶","⏩","⏪","⏫","⏬","ℹ","⏭","⏮","⏯","⏏","◀","➡️","⬅","⬆","⬇","↗","↘","↙","↖","↪","↩","⤴","⤵","✳️","✴️","❇️","㊗","㊙","⚕️","☦️","♾️","⚛️","⛎️","✝️","☪️","☮️","☯️","☸️","♈️","♉️","♊️","♋️","♌️","♍️","♎️","♏️","♐️","♑️","♒️","♓️","❤️","❣️","♠️","♣️","♥️","♦️","♀️","♂️","♻️","☢️","☣️","⚜️","➰️","➿️","☠️","⬛","⬜","⚪️","⚫️","▪","▫","◻","◼","◽","◾","(◕‿◕✿)","(づ￣ ³￣)づ",'(⁄ ⁄•⁄ω⁄•⁄ ⁄)',"( ་ − ་ )ུ ","( ༎ຶ ۝ ༎ຶ )","( う-´)づ︻╦̵̵̿╤──   (˚☐˚”)/","_(┐「ε:)_","ʕ ·(エ)· ʔ"," (⊚︷⊚) "," ~(￣▽￣)~ "," O(∩_∩)O "," ٩( ‘ω’  )و "," ★ "," ✪ "
]


var EmojiDescriptions = [
    "meow cat head cute hey :D hello hi",
    "gobo head cute hey :D hello hi baby",
    "food waffle yummy",
...
setInterval(scanAndCreateAddEmojiButtons,300)